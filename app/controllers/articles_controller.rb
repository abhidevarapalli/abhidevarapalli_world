class ArticlesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @article.update(article_params)
        format.html { redirect_to @article, notice: 'Category was successfully updated.' }
  ...
  def destroy
    @article.destroy
    respond_to do |format|
      format.html { redirect_to articles_url, notice: 'Category was successfully destroyed.' }
